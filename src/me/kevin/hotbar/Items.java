...
public class Items {
    ...
    public static void setItems(Player p) {
        ...
        p.getInventory().setItem(1, new ItemManager("§e§lSpieler-Verstecken", Material.BONE, (byte)0, 1, "").build());
        p.getInventory().setItem(3, new ItemManager("§e§lSilentlobbyLobby", Material.BEACON, (byte)0, 1, "").build());
        ...
        p.getInventory().setItem(8, new ItemManager("§e§lLobbySwitcher", Material.CHEST, (byte)0, 1, "").build());
        } else {
        p.getInventory().clear();
